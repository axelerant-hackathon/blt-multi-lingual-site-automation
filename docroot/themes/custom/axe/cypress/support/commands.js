...
Cypress.Commands.add("deleteUser", function (user) {
  let drush = "lando drush";
  cy.exec(`${drush} cr`, { timeout: 120000 });
 ...
 */
Cypress.Commands.add(
  "verifyInnerTextByLocator",
  function (locator, assertText) {
 ...
 */
Cypress.Commands.add(
  "clickByLocatorAndPartialText",
  function (locator, textContent) {
...
Cypress.Commands.add("setValueByJQuery", function (locator, inputText) {
  cy.get(`${locator}`, { timeout: 10000 })
    .invoke("val", inputText, { parseSpecialCharSequences: false })
